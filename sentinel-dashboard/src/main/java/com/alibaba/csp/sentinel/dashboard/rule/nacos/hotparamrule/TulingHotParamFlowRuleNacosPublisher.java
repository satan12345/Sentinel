...
* @version: 1.0
*/
@Component("tulingHotParamFlowRuleNacosPublisher")
public class TulingHotParamFlowRuleNacosPublisher implements DynamicRulePublisher<List<ParamFlowRuleEntity>> {
